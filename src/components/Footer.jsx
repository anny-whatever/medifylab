...
function Footer() {
  ...
  return (
    <>
      {/* ========== FOOTER ========== */}
      <Toaster richColors />
      <footer className="w-full mt-auto top-full bg-zinc-800">
        <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
          {/* Grid */}
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
            <div className="col-span-full lg:col-span-1">
              <a
                className="flex text-2xl font-semibold text-primary text-displaymedium gap-x-2"
                href="#"
                aria-label="Brand"
              >
            ...
            <div className="col-span-2">
              ...
              <form>
                <div className="flex flex-col items-center gap-2 p-2 mt-4 bg-white rounded-lg sm:flex-row sm:gap-3">
